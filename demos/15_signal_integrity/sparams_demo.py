...
class SParametersDemo(BaseDemo):
    ...
    def validate_results(self, suite: ValidationSuite) -> None:
        ...
        suite.check_greater(
            "Minimum return loss",
            self.results.get("min_return_loss_db", 0),
            5,  # At least 5 dB
        ...
        suite.check_less(
            "IL at 10 GHz",
            self.results.get("il_10ghz_db", 100),
            20,  # Less than 20 dB
            category="insertion_loss",
        )

        # Check VSWR is reasonable
        suite.check_less(
            "Maximum VSWR",
            self.results.get("max_vswr", 100),
            2.0,  # Less than 2:1
            category="vswr",
        )
        ...
        suite.check_less(
            "ABCD round-trip error",
            self.results.get("abcd_roundtrip_error", 1),
            1e-6,  # Very small error
            category="conversion",
        )
        ...
        suite.check_range(
            "Cascade IL ratio",
            self.results.get("cascade_il_ratio", 0),
            1.5,
            2.5,  # Should be ~2x
            category="cascade",
        )
