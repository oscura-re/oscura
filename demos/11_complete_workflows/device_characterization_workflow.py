"""Device Characterization Workflow: device characterization.
...
class DeviceCharacterizationWorkflowDemo(BaseDemo):
    """Demonstrates device characterization."""

    name = "Device Characterization Workflow"
    description = "device characterization"
    ...
    def run_analysis(self) -> None:
        ...
        print_header("Device Characterization Workflow")
