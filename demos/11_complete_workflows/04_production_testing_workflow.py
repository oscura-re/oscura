...
class ProductionTestingWorkflowDemo(BaseDemo):
    """Demonstrates production testing workflow."""

    name = "Production Testing Workflow"
    description = "production testing workflow"
    ...
    def run_analysis(self) -> None:
        ...
        print_header("Production Testing Workflow")
