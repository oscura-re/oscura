"""Automotive Diagnostics Workflow: automotive diagnostics end-to-end.
...
class AutomotiveDiagnosticsWorkflowDemo(BaseDemo):
    """Demonstrates automotive diagnostics end-to-end."""

    name = "Automotive Diagnostics Workflow"
    description = "automotive diagnostics end-to-end"
    ...
    def run_analysis(self) -> None:
        ...
        print_header("Automotive Diagnostics Workflow")
