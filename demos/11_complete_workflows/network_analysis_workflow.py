"""Network Analysis Workflow: network protocol analysis workflow.
...
class NetworkAnalysisWorkflowDemo(BaseDemo):
    """Demonstrates network protocol analysis workflow."""

    name = "Network Analysis Workflow"
    description = "network protocol analysis workflow"
    ...
    def run_analysis(self) -> None:
        ...
        print_header("Network Analysis Workflow")
...
if __name__ == "__main__":
    demo = NetworkAnalysisWorkflowDemo()
    result = demo.run()
