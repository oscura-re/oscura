"""Failure Analysis Workflow: failure analysis workflow.
...
class FailureAnalysisWorkflowDemo(BaseDemo):
    """Demonstrates failure analysis workflow."""

    name = "Failure Analysis Workflow"
    description = "failure analysis workflow"
    ...
    def run_analysis(self) -> None:
        ...
        print_header("Failure Analysis Workflow")
