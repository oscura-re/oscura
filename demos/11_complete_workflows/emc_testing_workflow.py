"""EMC Testing Workflow: EMC testing end-to-end.
...
class EMCTestingWorkflowDemo(BaseDemo):
    """Demonstrates EMC testing end-to-end."""

    name = "EMC Testing Workflow"
    description = "EMC testing end-to-end"
    ...
    def run_analysis(self) -> None:
        ...
        print_header("EMC Testing Workflow")
