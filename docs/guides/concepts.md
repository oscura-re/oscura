...
**Working examples**: See [Complete Workflows Demo](https://github.com/lair-click-bats/oscura/tree/main/demos/19_complete_workflows)
...
→ [Power Demo](https://github.com/lair-click-bats/oscura/tree/main/demos/14_power_analysis)

### 2. **Digital Protocol Analysis**

UART, SPI, I2C, CAN decoding and validation
→ [Protocol Demo](https://github.com/lair-click-bats/oscura/tree/main/demos/04_serial_protocols)

### 3. **Protocol Reverse Engineering**

Unknown signal analysis, CRC recovery, state machine learning
→ [RE Demo](https://github.com/lair-click-bats/oscura/tree/main/demos/17_signal_reverse_engineering)

### 4. **Compliance Validation**

IEEE standards, EMC testing, automotive diagnostics
→ [Spectral Demo](https://github.com/lair-click-bats/oscura/tree/main/demos/12_spectral_compliance)
...
→ [Custom DAQ Demo](https://github.com/lair-click-bats/oscura/tree/main/demos/03_custom_daq)
