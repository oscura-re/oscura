-- sensor_proto.lua
-- Generated by Oscura on 2026-01-27T16:58:11.346141+00:00
--
...
local f_sensor_type = ProtoField.uint8(
    ...
    base.HEX, {[1] = "Temperature", [2] = "Humidity", [3] = "Pressure", [4] = "Light", [5] = "Accelerometer"}
)
...
local f_flags = ProtoField.uint8(
    "sensor_proto.flags",
    "Status flags",
    base.HEX
)
...
-- Register fields
sensor_proto_proto.fields = { f_magic, f_version, f_sensor_type, f_sensor_id, f_timestamp, f_value, f_flags, f_checksum }
...
function sensor_proto_proto.dissector(buffer, pinfo, tree)
    ...
    -- Fixed-length field: flags (1 bytes)
    if offset + 1 > pktlen then
        subtree:add_expert_info(PI_MALFORMED, PI_ERROR, "Truncated flags")
        return pktlen
    end
